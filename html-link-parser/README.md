...
Chances are your first version will include the text from comments inside a link tag. Mine did. Use [ex4.html](res/ex4.html) to test that case out and fix the bug.
